        ...
        create or replace table `steam_lakehouse`.`dbt_dev_gold`.`dim_game`
      ...
      comment 'Dimension conforme de juego. Combina catalogo de Steam, metadata de IGDB y resumen de reseñas. Grano: un registro por appid.
'
