create or replace view `steam_lakehouse`.`dbt_dev_silver`.`stg_igdb__games`
...
, 
  ...
  comment 'Metadata de IGDB, una fila por appid de Steam.'
...
with source as (
    ...
    select * from `steam_lakehouse`.`bronze`.`igdb_games`
