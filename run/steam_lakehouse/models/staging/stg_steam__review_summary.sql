create or replace view `steam_lakehouse`.`dbt_dev_silver`.`stg_steam__review_summary`
...
, 
  ...
  comment 'Resumen de reseñas por juego con ratio positivo calculado.'
...
with source as (
    ...
    select * from `steam_lakehouse`.`bronze`.`steam_review_summary`
